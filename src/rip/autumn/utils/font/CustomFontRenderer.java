...
import rip.autumn.utils.font.CFont;
...
extends CFont {
    ...
    public float drawCenteredStringWithShadow(String text, float x, float y, int color) {
        float shadowWidth = this.drawString(text, (double)(x - (float)this.getStringWidth(text) / 2.0f) + 0.45, (double)y + 0.5, color, true);
        return this.drawString(text, x - (float)this.getStringWidth(text) / 2.0f, y, color);
    }
    ...
    public float drawCenteredStringWithShadow(String text, double x, double y, int color) {
        float shadowWidth = this.drawString(text, x - (double)((float)this.getStringWidth(text) / 2.0f) + 0.45, y + 0.5, color, true);
        return this.drawString(text, x - (double)((float)this.getStringWidth(text) / 2.0f), y, color);
    }
