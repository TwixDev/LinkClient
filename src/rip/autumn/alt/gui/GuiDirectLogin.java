...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
                if (this.combined.getText().isEmpty() || !this.combined.getText().contains(":")) break;
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, this.thread == null ? (Object)((Object)EnumChatFormatting.GRAY) + "Waiting for user input." : this.thread.getStatus(), this.width / 2, 29, -1);
