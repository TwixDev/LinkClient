...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        ItemStack itemStack = itemstack = this.draggedStack == null ? inventoryplayer.getItemStack() : this.draggedStack;
        if (itemstack != null) {
            int j2 = 8;
            ...
            if (this.draggedStack != null && this.isRightMouseClick) {
                ...
                if (itemstack.stackSize == 0) {
                    s = "" + (Object)((Object)EnumChatFormatting.YELLOW) + "0";
                }
            }
    ...
    private void drawSlot(Slot slotIn) {
        ...
        if (slotIn == this.clickedSlot && this.draggedStack != null && this.isRightMouseClick && itemstack != null) {
            ...
            if (Container.canAddItemToSlot(slotIn, itemstack1, true) && this.inventorySlots.canDragIntoSlot(slotIn)) {
                ...
                if (itemstack.stackSize > itemstack.getMaxStackSize()) {
                    s = (Object)((Object)EnumChatFormatting.YELLOW) + "" + itemstack.getMaxStackSize();
                    itemstack.stackSize = itemstack.getMaxStackSize();
                }
                if (itemstack.stackSize > slotIn.getItemStackLimit(itemstack)) {
                    s = (Object)((Object)EnumChatFormatting.YELLOW) + "" + slotIn.getItemStackLimit(itemstack);
        ...
        if (itemstack == null && (s1 = slotIn.getSlotTexture()) != null) {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (mouseButton == 0) {
            for (GuiButton button : this.buttonList) {
                ...
                if (button.id != 2274) continue;
                mod = Autumn.MANAGER_REGISTRY.moduleManager.getModuleOrNull(InventoryManagerMod.class);
                if (mod.isEnabled()) {
                    mod.toggle();
                }
                if (!(mod0 = Autumn.MANAGER_REGISTRY.moduleManager.getModuleOrNull(AutoArmorMod.class)).isEnabled()) continue;
                mod0.toggle();
            }
        }
            ...
            if (GuiContainer.isShiftKeyDown()) {
                if (slot != null && slot.inventory != null && this.shiftClickedSlot != null) {
                    for (Slot slot2 : this.inventorySlots.inventorySlots) {
                        if (slot2 == null || !slot2.canTakeStack(this.mc.thePlayer) || !slot2.getHasStack() || slot2.inventory != slot.inventory || !Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true)) continue;
    ...
    protected boolean isPointInRegion(int left, int top, int right, int bottom, int pointX, int pointY) {
        int i = this.guiLeft;
        int j = this.guiTop;
        return (pointX -= i) >= left - 1 && pointX < left + right + 1 && (pointY -= j) >= top - 1 && pointY < top + bottom + 1;
    }
