...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Autumn.EVENT_BUS_REGISTRY.eventBus.post(new RenderGuiEvent(scaledresolution, partialTicks));
        ...
        if (this.showCrosshair()) {
            RenderCrosshairEvent event = new RenderCrosshairEvent(scaledresolution);
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        StreamerMod instance = Autumn.MANAGER_REGISTRY.moduleManager.getModuleOrNull(StreamerMod.class);
        if (instance != null && instance.shouldHideScoreboard()) {
            return;
        }
        ...
        for (Object score10 : arraylist1) {
            ...
            double d3 = i1;
            this.getFontRenderer();
            GuiIngame.drawRect(d, d2, d3, l + 9, 0x50000000);
            this.getFontRenderer().drawString(s1, j, l, 0x20FFFFFF);
            this.getFontRenderer().drawString(s2, i1 - this.getFontRenderer().getStringWidth(s2), l, 0x20FFFFFF);
            if (k != arraylist1.size()) continue;
            String s3 = p_180475_1_.getDisplayName();
            double d4 = j - 2;
            this.getFontRenderer();
            GuiIngame.drawRect(d4, l - 9 - 1, i1, l - 1, 0x60000000);
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
            ...
            this.getFontRenderer().drawStringWithShadow(s, i / 2 - this.getFontRenderer().getStringWidth(s) / 2, b0 - 10, 0xFFFFFF);
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
