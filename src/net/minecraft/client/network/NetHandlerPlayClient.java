...
implements INetHandlerPlayClient {
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        double velX = (double)packetIn.getSpeedX() / 8000.0;
        double velY = (double)packetIn.getSpeedY() / 8000.0;
        double velZ = (double)packetIn.getSpeedZ() / 8000.0;
        switch (packetIn.getType()) {
            ...
            case 76: {
                entity = new EntityFireworkRocket(world, d0, d1, d2, null);
                break;
            }
            case 63: {
            ...
            case 73: {
                entity = new EntityPotion((World)world, d0, d1, d2, packetIn.func_149009_m());
                packetIn.func_149002_g(0);
                break;
            }
            case 75: {
            ...
            case 50: {
                entity = new EntityTNTPrimed(world, d0, d1, d2, null);
                break;
            }
            case 78: {
            ...
            case 70: {
                entity = new EntityFallingBlock(world, d0, d1, d2, Block.getStateById(packetIn.func_149009_m() & 0xFFFF));
                packetIn.func_149002_g(0);
            }
        }
        if (entity != null) {
            ...
            if (packetIn.func_149009_m() > 0) {
                Entity entity2;
                if (packetIn.getType() == 60 && (entity2 = world.getEntityByID(packetIn.func_149009_m())) instanceof EntityLivingBase && entity instanceof EntityArrow) {
    ...
    public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        WorldClient world = this.clientWorldController;
        EntityXPOrb entity = new EntityXPOrb(world, (double)packetIn.getX() / 32.0, (double)packetIn.getY() / 32.0, (double)packetIn.getZ() / 32.0, packetIn.getXPValue());
        entity.serverPosX = packetIn.getX();
        entity.serverPosY = packetIn.getY();
        entity.serverPosZ = packetIn.getZ();
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
        ...
        entityotherplayermp.inventory.mainInventory[currentItem] = i == 0 ? null : new ItemStack(Item.getItemById(i), 1, 0);
    ...
    public void handleCollectItem(S0DPacketCollectItem packetIn) {
        ...
        if (entity != null) {
            ...
            this.gameController.effectRenderer.addEffect(new EntityPickupFX((World)world, entity, entitylivingbase, 0.5f));
    ...
    public void handleUpdateSign(S33PacketUpdateSign packetIn) {
        ...
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, mc);
        boolean flag = false;
        if (world.isBlockLoaded(packetIn.getPos()) && (tileentity = world.getTileEntity(packetIn.getPos())) instanceof TileEntitySign) {
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn) {
        ...
        } else if (packetIn.eventType == S42PacketCombatEvent.Event.ENTITY_DIED && (entity1 = world.getEntityByID(packetIn.field_179774_b)) instanceof EntityPlayer) {
    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Map<UUID, NetworkPlayerInfo> infoMap = this.playerInfoMap;
        List<S38PacketPlayerListItem.AddPlayerData> func_179767_a = packetIn.func_179767_a();
        int func_179767_aSize = func_179767_a.size();
        block6: for (int i = 0; i < func_179767_aSize; ++i) {
            S38PacketPlayerListItem.AddPlayerData s38packetplayerlistitem$addplayerdata = func_179767_a.get(i);
            ...
            NetworkPlayerInfo networkplayerinfo = infoMap.get(s38packetplayerlistitem$addplayerdata.getProfile().getId());
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        ...
        if (s.startsWith("level://")) {
            ...
            if (file2.isFile()) {
                ...
                Futures.addCallback(mc.getResourcePackRepository().setResourcePackInstance(file2), (FutureCallback)new FutureCallback<Object>(){
            ...
            networkManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.ACCEPTED));
            Futures.addCallback(mc.getResourcePackRepository().downloadResourcePack(s, s1), (FutureCallback)new FutureCallback<Object>(){
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            ItemStack itemstack;
            if (!"MC|BOpen".equals(packetIn.getChannelName()) || (itemstack = this.gameController.thePlayer.getCurrentEquippedItem()) == null || itemstack.getItem() != Items.written_book) return;
    ...
    public void handleTeams(S3EPacketTeams packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Scoreboard scoreboard = this.clientWorldController.getScoreboard();
        ScorePlayerTeam scoreplayerteam = packetIn.func_149307_h() == 0 ? scoreboard.createTeam(packetIn.func_149312_c()) : scoreboard.getTeam(packetIn.func_149312_c());
