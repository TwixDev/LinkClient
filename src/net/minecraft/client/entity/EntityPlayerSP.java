...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        EventUpdate eventPreUpdate = new EventUpdate(rotationYaw, rotationPitch, EventType.PRE);
        EventManager.call(eventPreUpdate);
        EventUpdate eventPostUpdate = new EventUpdate(rotationYaw, rotationPitch, EventType.POST);

        rotationYaw = eventPreUpdate.getYaw();
        rotationPitch = eventPreUpdate.getPitch();
        ...
        EventManager.call(eventPostUpdate);
    }
